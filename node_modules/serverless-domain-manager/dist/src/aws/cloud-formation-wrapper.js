...
class CloudFormationWrapper {
    ...
    getImportValues(names) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.cloudFormation.send(new client_cloudformation_1.ListExportsCommand({}));
    ...
    getNestedStack(logicalResourceId, stackName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.cloudFormation.send(new client_cloudformation_1.DescribeStacksCommand({}));
