    ...
    validateDomainConfigs() {
        this.domains.forEach((domain) => {
            if (domain.allowPathMatching) {
                logging_1.default.logWarning(`"allowPathMatching" is set for ${domain.givenDomainName}.
            ...
            try {
                if (!domain.domainInfo) {
                    ...
                    if (!domain.certificateArn) {
                        ...
                        logging_1.default.logInfo(`Searching for a certificate with the '${searchName}' domain`);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            yield Promise.all(this.domains.map((domain) => __awaiter(this, void 0, void 0, function* () {
                ...
                const filteredMappings = mappings.filter((mapping) => {
                    return mapping.apiId === domain.apiId || (mapping.basePath === domain.basePath && domain.allowPathMatching);
                });
